...
<template>
    <div class="isometric_A">
        ...
        <div class="container" v-bind:style="containerHeight">
            <div class="half left">
                <wwObject class="title" v-bind:ww-object="section.data.title" v-bind:section="section"></wwObject>
                <wwObject class="description" v-bind:ww-object="section.data.text" v-bind:section="section"></wwObject>
            </div>
                ...
                <div class="cards-container">
                    <div class="cards-column" v-bind:style="getColumnWidth" v-for="columnIndex in getColumnCount" v-bind:key="columnIndex">
                        <div class="card hover-transition" v-for="(card, index) in getCards(columnIndex - 1)" v-bind:key="card.uniqueId" :data-unique-id="card.uniqueId" @click="openPopup(card)" v-bind:class="{'active': activeCardIndex == index + (columnIndex-1)*3}">
                            ...
                            <div class="p p2" />
                            <div class="p p1" />
                            <wwObject class="preview" v-bind:ww-object="card.image" v-bind:section="section"></wwObject>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="flying-popup" v-if="openCard" v-bind:class="{'flying': startAnim}">
            ...
            <wwObject class="card-placeholder" v-bind:ww-object="openCard.image" v-bind:section="section"></wwObject>
            ...
            <div class="content">
                ...
                <div class="logo-container">
                    <wwObject class="logo" v-bind:ww-object="openCard.logo" v-bind:section="section" ww-category="icon"></wwObject>
                </div>

                <div class="row">
                    <div class="col-xs-12 ">
                        <wwObject class="title" v-bind:ww-object="openCard.title" v-bind:section="section" ww-no-anim="true"></wwObject>
                        <wwObject class="text" v-bind:ww-object="openCard.text" v-bind:section="section" ww-no-anim="true"></wwObject>
                    </div>
                </div>

                <div class="buttons-container">
                    <div class="button">
                        <wwObject class="button-wrapper" v-bind:ww-object="openCard.button1" v-bind:section="section"></wwObject>
                    </div>
                    <div class="button">
                        <wwObject class="button-wrapper" v-bind:ww-object="openCard.button2" v-bind:section="section"></wwObject>
                    </div>
                </div>
            </div>
        </div>

        <wwObject v-if="openCard" class="flying-card" v-bind:ww-object="openCard.image" v-bind:section="section" v-bind:style="getCardPos" v-bind:class="{'flying': startAnim}"></wwObject>
